...
-- Read-only snapshot of all effects currently tracked on the client.
-- Each entry: { Id, Name, Lifetime, MaxLifetime, IsOverLifetime }.
function client.GetActiveEffects()
	return entries.getActiveEntries()
end
